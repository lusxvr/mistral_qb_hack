...
class TravelRecResponse(BaseModel):
    ...
    answer: str = Field(description="For the chat with the user: The FULL answer for the user for the chat, very likely over multiple lines. Make sure to provide the full text")
    ...
    ad_auction: dict = Field(description="For the corresponding add, leave this blank")
