...
<template>
  ...
  >
    <SliderTrack
      class="relative h-1.5 w-full data-[orientation=vertical]:w-1.5 grow overflow-hidden rounded-full bg-slate-900/20 dark:bg-slate-50/20"
    >
      <SliderRange
        class="absolute h-full data-[orientation=vertical]:w-full bg-slate-900 dark:bg-slate-50"
      />
    </SliderTrack>
    <SliderThumb
